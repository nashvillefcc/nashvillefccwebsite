...
import { faMeetup, faDiscord, faSlack, faGithub, faTwitter, faFacebook } from '@fortawesome/free-brands-svg-icons'
        ...
        <footer>
            ...
            <Connect className="connectLogo" alt={`Connect Logo`}/>
                <div className="socials">
                    ...
                    <a href="https://discord.gg/cX9BkKrAPV" aria-label="Discord" rel="noopener noreferrer" target="_blank">
                ...
                <div className="emailAndCopyright">
                    <div>
                        <a href="mailto:setha@hey.com" className="emailLink">
                            ...
                            <p className="emailName">setha@hey.com</p>                     {/* This will change to something else once we setup a domain */}
                        </a>
